<?php
   ...
   *
   * Now with "klein" routing from version 1.2.0 when it was still a single file:
   * https://github.com/klein/klein.php/releases/tag/v1.2.0 
   * See from line 99 below; licenses are compatible (MIT)
   *
   */ 
